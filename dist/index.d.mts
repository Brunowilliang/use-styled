 ...
 */
type BooleanVariant<T extends ElementType> = {
    true: VariantValue<T>;
};
/**
 ...
 * @template T - The base React element type.
 */
type VariantsConfig<T extends ElementType> = Record<string, StringVariant<T> | BooleanVariant<T>>;
/**
 ...
 */
type VariantKeys<V> = V extends VariantsConfig<any> ? {
 ...
 * @template V - The VariantsConfig object.
 */
type CompoundVariantConditions<V> = VariantKeys<V>;
/**
 ...
 * @template V - The VariantsConfig object.
 */
type CompoundVariant<T extends ElementType, V extends VariantsConfig<T>> = CompoundVariantConditions<V> & VariantValue<T>;
/**
 ...
 * @template T - The base React element type.
 */
type StyledConfigWithoutVariants<T extends ElementType> = BaseStyledConfig<T>;
/**
 ...
 * @template V - The VariantsConfig object.
 */
type StyledConfigWithVariants<T extends ElementType, V extends VariantsConfig<T>> = BaseStyledConfig<T> & {
 ...
 */
declare function useStyled<T extends ElementType>(component: T, config: StyledConfigWithoutVariants<T>): ComponentType<ElementProps<T>>;
/**
 * Creates a styled component factory.
 ...
 */
declare function useStyled<T extends ElementType, V extends VariantsConfig<T> = VariantsConfig<T>>(component: T, config: StyledConfigWithVariants<T, V>): ComponentType<StyledPropsWithVariants<T, V>>;

export { type BooleanVariant, type CompoundVariant, type CompoundVariantConditions, type ElementProps, type StringVariant, type StyledConfigWithVariants, type StyledConfigWithoutVariants, type StyledPropsWithVariants, type VariantKeys, type VariantValue, type VariantsConfig, useStyled };
